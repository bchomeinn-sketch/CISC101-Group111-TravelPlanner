> Change Log (2025-11-21): 
   > – Updated 3 for more constraints
...
3. **Too Far or Long Travel**
   ...
   - If user requests 'short walks only' and transfer between activities > 15 min or walking segment > 750 m → select alternatives with shorter walking distances and minimize long transit hops.

   - Otherwise, if transfer between activities > 25 min or > 5 km → pick a closer alternative or add a short transit hop.
